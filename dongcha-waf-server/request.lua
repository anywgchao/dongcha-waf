local cookiejar = require "resty.openwaf.cookie"
local cjson = require "cjson.safe"
local zlib = require "resty.openwaf.ffi-zlib"
local _M = {}
_M.version = "1.0"
...
local function _http_full_info()
  ...
  full_info['xxf_addr'] = _remote_addr() or "-"
...
_M.request = {
	...
	TIME_EPOCH = function() return tonumber(ngx.time()) end,
