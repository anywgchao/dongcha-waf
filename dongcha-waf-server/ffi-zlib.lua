--A Lua module using LuaJIT's FFI feature to access zlib. Intended primarily
--for use within OpenResty to allow manipulation of gzip encoded HTTP responses.
