    ...
    try:
        ...
        if ReportItem_list:
            for node in ReportItem_list:
                ...
                try:
                    Request = node.getElementsByTagName("Description")[0].firstChild.data
                except:
                    Request = ""
                try:
                ...
                try:
                    ...
                    recommendation = ""
                try:
                    CVSS = node.getElementsByTagName("Database")[0].firstChild.data
                except:
                    CVSS = ""
                try:
                    CVSS3 = node.getElementsByTagName("URL")[1].firstChild.data
                except:
                    CVSS3 = ""
